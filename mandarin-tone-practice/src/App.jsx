...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center p-4 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 transition-colors">
      ...
      <h1 className="text-3xl font-bold mb-4">Mandarin Tone Practice</h1>
...
//   const updateStats = async (correctDelta, totalDelta, mistakes = []) => {
//     setStats(prev => {
//       const c = prev.correct + correctDelta;
//       const t = prev.total + totalDelta;
...
//       {/* Top-right corner buttons and speed control */}
//       <div className="absolute top-4 right-4 flex gap-2 items-start">
       
//       {/* Speed control (gear + slider) */}
//       <div className="flex flex-col items-center">
//         <button
...
//         <button
//           onClick={() => setShowAbout(true)}
//           // Match the styling of the gear button
//           className="p-2 rounded-full hover:bg-gray-200 transition"
//           title="About this project"
//         >
//           <svg
...
//             strokeLinejoin="round"
//           >
//             {/* Path for a simple Question Mark '?' icon */}
//             <circle cx="12" cy="12" r="10"></circle>
//             <path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"></path>
//             <line x1="12" y1="17" x2="12.01" y2="17"></line>
//           </svg>
